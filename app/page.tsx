...
import { Box, Cloud, Code, Cpu, Database, ExternalLink, GitBranch, Github, GitPullRequest, Globe, Linkedin, Mail, Menu, Server, Terminal, Users, X } from 'lucide-react'
        ...
        <section id="about" className="py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-2xl mx-auto">
              <p className="mb-4">
                I&apos;m a passionate full stack developer with over 5 years of experience in creating robust and scalable web applications. My expertise spans across front-end and back-end technologies, with a strong focus on JavaScript ecosystems.
              </p>
              <p>
                I thrive in collaborative environments and am always eager to take on new challenges that push the boundaries of what&apos;s possible in web development.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-md mx-auto">
              <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
                ...
                <Button type="submit" className="w-full transition-transform duration-300 hover:scale-105">Send Message</Button>
              </form>
            </div>
          </div>
        </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 mt-4 md:mt-0">
              ...
              <a href="https://linkedin.com/in/johndoe" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors duration-300">
                <Linkedin className="w-6 h-6" />
              </a>
              <a href="mailto:john@example.com" className="text-muted-foreground hover:text-primary transition-colors duration-300">
